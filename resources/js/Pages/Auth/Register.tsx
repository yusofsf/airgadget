    ...
    return (
        <GuestLayout>
            ...
            <div className="auth-heading" dir="rtl">
                ...
                <p>با نام، شماره موبایل و رمز عبور حساب خود را بسازید. ایمیل اختیاری است.</p>
            </div>
            <form className="auth-form" onSubmit={submit} dir="rtl">
                <div className="auth-two">
                    <label>نام<input required value={form.data.first_name} onChange={(event) => form.setData('first_name', event.target.value)} autoFocus /></label>
                    <label>نام خانوادگی<input required value={form.data.last_name} onChange={(event) => form.setData('last_name', event.target.value)} /></label>
                </div>
                ...
                <input required type="tel" inputMode="numeric" placeholder="۰۹۱۲۱۲۳۴۵۶۷" value={form.data.phone_number} onChange={(event) => form.setData('phone_number', event.target.value)} />
                ...
                <div className="auth-two">
                    <label>رمز عبور<input required type="password" value={form.data.password} onChange={(event) => form.setData('password', event.target.value)} /></label>
                    <label>تکرار رمز عبور<input required type="password" value={form.data.password_confirmation} onChange={(event) => form.setData('password_confirmation', event.target.value)} /></label>
                </div>
